...
/***/ "./src/js/modules/todoFooter.js":
/*!**************************************!*\
  !*** ./src/js/modules/todoFooter.js ***!
  \**************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* export default binding */ __WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _UI__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./UI */ \"./src/js/modules/UI.js\");\n\r\n\r\n/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__(todoItems) {\r\n  const todoArr = [];\r\n  todoItems.forEach((items) => {\r\n    if (items.classList.contains(\"active\")) {\r\n      todoArr.push(items);\r\n    }\r\n    _UI__WEBPACK_IMPORTED_MODULE_0__[\"default\"].todoFooterElem(todoItems, todoArr);\r\n  });\r\n}\r\n\n\n//# sourceURL=webpack://grouptest2-master/./src/js/modules/todoFooter.js?");
